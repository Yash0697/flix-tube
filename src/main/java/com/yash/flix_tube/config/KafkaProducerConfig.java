...
public class KafkaProducerConfig {
    ...
    @Value("${spring.kafka.producer.properties.metadata.fetch.timeout.ms}")
    private Integer metadataFetchTimeout;
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configProps.put("metadata.fetch.timeout.m", metadataFetchTimeout);
